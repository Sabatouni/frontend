...
export const translations = {
  en: {
    ...
    invoicesSubtitle: "Create and manage standalone invoices for tents, shisha, rentals and extra charges.",
    newInvoiceBtn: "＋ New Invoice",
    backToInvoicesBtn: "← Back to Invoices",
    searchInvoicesPlaceholder: "Search by customer or invoice number…",
    colInvoiceNumber: "Invoice No.",
    colCustomer: "Customer",
    colGrandTotal: "Grand Total",
    colPaid: "Paid",
    colAmountLeft: "Amount Left",
    viewPdfBtn: "View",
    editInvoiceBtn: "Edit",
    deleteInvoiceBtn: "Delete",
    downloadPdfBtn: "Download PDF",
    printInvoiceBtn: "Print",
    previewPdfTitle: "Invoice Preview",
    ...
    invoiceCreatedToast: "Invoice {{number}} created ✓",
    invoiceUpdatedToast: "Invoice {{number}} updated ✓",
    invoiceSaveError: "Could not save invoice: {{error}}",
    invoiceLoadError: "Could not load invoices: {{error}}",
    invoiceDeleteError: "Could not delete invoice: {{error}}",
    customerDetailsSection: "Customer Details",
    invCustomerNameLabel: "Name",
    invCustomerNamePlaceholder: "Customer name",
    invCustomerCompanyLabel: "Company",
    invCustomerCompanyPlaceholder: "Company (optional)",
    invContactPersonLabel: "Contact Person",
    invContactPersonPlaceholder: "Contact person (optional)",
    invCustomerPhoneLabel: "Phone Number",
    invCustomerPhonePlaceholder: "Phone number (optional)",
    invCustomerEmailLabel: "Email Address",
    invCustomerEmailPlaceholder: "Email address (optional)",
    invoiceDetailsSection: "Invoice Details",
    invoiceNumberLabel: "Invoice Number",
    invoiceNumberAutoHint: "Assigned automatically when saved",
    ...
    itemDescriptionPlaceholder: "e.g. VIP Tent",
    itemQuantityLabel: "Quantity",
    itemUnitPriceLabel: "Unit Price (TZS)",
    itemTotalLabel: "Total (TZS)",
    addItemBtn: "＋ Add Item",
    removeItemLabel: "Remove item",
    atLeastOneItemRequired: "Add at least one item with a description.",
    customerNameRequiredError: "Customer name is required.",
    notesLabel: "Notes",
    notesPlaceholder: "Notes (optional)",
    grandTotalLabel: "Grand Total",
    paidLabel: "Paid",
    amountLeftLabel: "Amount left to be Paid",
  ...
  sw: {
    ...
    categoryLabel: "Aina",
    filterByCategory: "Chuja kwa aina",
    allCategories: "Zote",
    ...
    // Invoices
    navInvoices: "Ankara",
    invoicesTitle: "Ankara",
    invoicesSubtitle: "Tengeneza na simamia ankara za hema, shisha, kukodisha na malipo ya ziada.",
    newInvoiceBtn: "＋ Ankara Mpya",
    backToInvoicesBtn: "← Rudi kwenye Ankara",
    searchInvoicesPlaceholder: "Tafuta kwa mteja au namba ya ankara…",
    colInvoiceNumber: "Namba ya Ankara",
    colCustomer: "Mteja",
    colGrandTotal: "Jumla Kuu",
    colPaid: "Kimelipwa",
    colAmountLeft: "Kiasi Kilichobaki",
    viewPdfBtn: "Angalia",
    editInvoiceBtn: "Hariri",
    deleteInvoiceBtn: "Futa",
    downloadPdfBtn: "Pakua PDF",
    printInvoiceBtn: "Chapisha",
    previewPdfTitle: "Muhtasari wa Ankara",
    generatingPdf: "Inatengeneza PDF…",
    closePreviewBtn: "Funga",
    noInvoicesFound: "Hakuna ankara zilizopatikana.",
    confirmDeleteInvoice: "Futa ankara hii? Haiwezi kurudishwa.",
    invoiceDeletedToast: "Ankara imefutwa ✓",
    invoiceCreatedToast: "Ankara {{number}} imetengenezwa ✓",
    invoiceUpdatedToast: "Ankara {{number}} imesasishwa ✓",
    invoiceSaveError: "Imeshindikana kuhifadhi ankara: {{error}}",
    invoiceLoadError: "Imeshindikana kupakia ankara: {{error}}",
    invoiceDeleteError: "Imeshindikana kufuta ankara: {{error}}",
    customerDetailsSection: "Taarifa za Mteja",
    invCustomerNameLabel: "Jina",
    invCustomerNamePlaceholder: "Jina la mteja",
    invCustomerCompanyLabel: "Kampuni",
    invCustomerCompanyPlaceholder: "Kampuni (hiari)",
    invContactPersonLabel: "Mtu wa Mawasiliano",
    invContactPersonPlaceholder: "Mtu wa mawasiliano (hiari)",
    invCustomerPhoneLabel: "Namba ya Simu",
    invCustomerPhonePlaceholder: "Namba ya simu (hiari)",
    invCustomerEmailLabel: "Barua Pepe",
    invCustomerEmailPlaceholder: "Barua pepe (hiari)",
    invoiceDetailsSection: "Taarifa za Ankara",
    invoiceNumberLabel: "Namba ya Ankara",
    invoiceNumberAutoHint: "Inapangwa kiotomatiki baada ya kuhifadhi",
    invoiceDateLabel: "Tarehe",
    validUntilLabel: "Halali Hadi",
    preparedByLabel: "Imeandaliwa Na",
    referenceLabel: "Kumbukumbu",
    referencePlaceholder: "Kumbukumbu (hiari)",
    itemsSectionTitle: "Bidhaa/Huduma",
    itemDescriptionLabel: "Maelezo",
    itemDescriptionPlaceholder: "mfano: VIP Tent",
    itemQuantityLabel: "Kiasi",
    itemUnitPriceLabel: "Bei kwa Kimoja (TZS)",
    itemTotalLabel: "Jumla (TZS)",
    addItemBtn: "＋ Ongeza Bidhaa",
    removeItemLabel: "Ondoa bidhaa",
    atLeastOneItemRequired: "Ongeza angalau bidhaa moja yenye maelezo.",
    customerNameRequiredError: "Jina la mteja linahitajika.",
    notesLabel: "Maelezo ya Ziada",
    notesPlaceholder: "Maelezo ya ziada (hiari)",
    grandTotalLabel: "Jumla Kuu",
    paidLabel: "Kimelipwa",
    amountLeftLabel: "Kiasi Kilichobaki Kulipwa",
